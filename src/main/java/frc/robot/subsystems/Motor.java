...
public class Motor {
     ...
     public Motor(int id, double supplyCurrentLimit, boolean isInverted){
     ...
     public Motor(int id, double supplyCurrentLimit, double kP, double kI, double kD){
     ...
     public void setSteerMotor(double goalAngleRadians){
         ...
         double currentAngleInRadians = getMotorEncoder() / 2048.0 * 2.0 * Math.PI / 12.8; 
         ...
         motor.set(ControlMode.Position, adjustedGoalAngleTicks * 12.8);
     ...
     public void setIntegratedEncoder(double position){
